...
import { updateMatchInApi as updateMatchInExternalApi } from "@/lib/api";
...
export async function PUT(req: NextRequest) {
    ...
    try {
        ...
        await updateMatchInExternalApi(season, body, token);
        ...
        console.error("Error in update-game route:", errorMessage);
